...
{
    unsafe class ET_ETTask_1_LoadSceneHandler_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ET.ETTask<BM.LoadSceneHandler>);
            args = new Type[]{};
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ET.ETTask<BM.LoadSceneHandler> instance_of_this_method = (ET.ETTask<BM.LoadSceneHandler>)typeof(ET.ETTask<BM.LoadSceneHandler>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
